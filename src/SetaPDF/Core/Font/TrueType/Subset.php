 ...
 * @version    $Id: Subset.php 1747 2022-06-21 10:25:58Z jan.slabon $
 */
    ...
    implements SetaPDF_Core_Font_FontInterface
{
    ...
    )
    {
        ...
        if ($ignoreLicenseRestrictions === false && $fontFile->isSubsettable() === false) {
    ...
    protected function _createSubset()
    {
        ...
        $descriptor = new SetaPDF_Core_Type_Dictionary([
            ...
            'StemV' => new SetaPDF_Core_Type_Numeric(50 + (int)(($os2Table->getWeightClass() / 65) ** 2)),
