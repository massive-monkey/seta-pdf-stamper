 ...
 * @version    $Id: HexString.php 1733 2022-06-02 07:39:42Z jan.slabon $
 */
    ...
    implements SetaPDF_Core_Type_StringValue, SetaPDF_Core_Type_ScalarValue
{
     ...
     */
    public static function ensureType($hexString)
    {
        return self::_ensureType(self::class, $hexString, 'Hex string value expected.');
    }
