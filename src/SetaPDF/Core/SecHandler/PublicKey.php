 ...
 * @version    $Id: PublicKey.php 1753 2022-06-28 14:42:54Z maximilian.kresse $
 */
    ...
    public function auth($recipientCert = null, $recipientKey = null)
    {
        try {
            ...
            switch ($subFilter) {
                ...
                case 'adbe.pkcs7.s5':
                    /**
                     * @var SetaPDF_Core_Type_Dictionary $cf
                     * @var SetaPDF_Core_Type_Dictionary $defaultCryptFilter
                     */
