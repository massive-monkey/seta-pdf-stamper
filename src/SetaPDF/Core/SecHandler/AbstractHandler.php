 ...
 * @version    $Id: AbstractHandler.php 1753 2022-06-28 14:42:54Z maximilian.kresse $
 */
...
abstract class SetaPDF_Core_SecHandler_AbstractHandler
{
    ...
    )
    {
        ...
        if ($this->_encryptionDictionary->offsetExists('CF')) {
            ...
            /**
             * @var SetaPDF_Core_Type_Dictionary $cryptFilters
             * @var SetaPDF_Core_Type_Dictionary $streamFilter
             */
