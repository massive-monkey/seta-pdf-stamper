 ...
 * @version    $Id: GlyphData.php 1753 2022-06-28 14:42:54Z maximilian.kresse $
 */
    ...
    extends SetaPDF_Core_Font_TrueType_Subset_Table
{
     ...
     *
     * @var array<SetaPDF_Core_Font_TrueType_Subset_Table_GlyphData_Glyph|false>
     */
    private $_glyphs = [];
    ...
    public function write(SetaPDF_Core_Writer_WriterInterface $writer)
    {
        ...
        /**
         * @var SetaPDF_Core_Font_TrueType_Subset_Table_IndexToLocation $loca
         * @var SetaPDF_Core_Font_TrueType_Subset_Table_Header $head
         */
