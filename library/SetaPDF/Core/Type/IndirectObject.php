 ...
 * @version    $Id: IndirectObject.php 1706 2022-03-28 10:40:28Z jan.slabon $
 */
    ...
    implements SplObserver, SetaPDF_Core_Type_IndirectObjectInterface, SetaPDF_Core_Type_Owner
{
     ...
     */
    public static function ensureType($indirectObject)
    {
        return self::_ensureType(self::class, $indirectObject, 'Indirect object expected.', false);
    }
