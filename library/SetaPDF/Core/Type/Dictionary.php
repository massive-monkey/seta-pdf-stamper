 ...
 * @version    $Id: Dictionary.php 1706 2022-03-28 10:40:28Z jan.slabon $
 */
    ...
    implements SplObserver, ArrayAccess, Countable, Iterator
{
     ...
     */
    public static function ensureType($dictionary)
    {
        return self::_ensureType(self::class, $dictionary, 'Dictionary value expected.');
    }
