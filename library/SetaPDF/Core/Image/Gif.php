...
class SetaPDF_Core_Image_Gif extends SetaPDF_Core_Image
{
    ...
    protected function _process()
    {
        ...
        $reader = new SetaPDF_Core_Image_Gif_Reader($this->_binaryReader);
        $this->_frames = $reader->createFrames();
        $this->_width = $reader->screenDescriptor->width;
        $this->_height = $reader->screenDescriptor->height;
    }
